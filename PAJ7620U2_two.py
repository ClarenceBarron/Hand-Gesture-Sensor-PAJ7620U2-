...
#servo1 = Servo(12)
#servo2 = Servo(13)
servo1 = AngularServo(12, min_pulse_width=0.0004, max_pulse_width=0.0025)
servo2 = AngularServo(13, min_pulse_width=0.0004, max_pulse_width=0.0025)
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if (gesture == "LEFT" or gesture == "FORWARD" or gesture == "UP"):
            #turnOff()
	    ...
	    servo1.angle = 90
	    servo2.angle = 90
        elif (gesture == "RIGHT" or gesture == "BACKWARD" or gesture == "DOWN"):
            #turnOn()
            #GPIO.output(12, GPIO.LOW)
            #servo1.max() #Controls Warm Colored Servo
	    #servo2.max() #Controls Cool Colored Servo
	    servo1.angle = -90
	    servo2.angle = -90
